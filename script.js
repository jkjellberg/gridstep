...
const drumkits = ["808", "909", "LinnDrum", "LinnDream", "Oberheim", "Drumulator"]; // Keeps tracks of the different soundbanks that is available, should have the same name as the folder that contains the samples.
